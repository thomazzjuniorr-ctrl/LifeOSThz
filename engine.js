...
function getCloudSyncSettings(state) {
  ...
  return {
    ...
    managedByRuntime: defaults.managedByRuntime || toBoolean(source.managedByRuntime, false),
    provider: source.provider || defaults.provider,
    apiBaseUrl: String(source.apiBaseUrl || defaults.apiBaseUrl || "/api/sync").trim(),
    ...
    workspaceId: String(source.workspaceId || defaults.workspaceId || source.workspaceKey || defaults.workspaceKey || "").trim(),
...
export function saveSettings(state, payload) {
  ...
  nextState.settings.cloudSync = {
    ...
    managedByRuntime: toBoolean(payload.syncManagedByRuntime, nextState.settings.cloudSync.managedByRuntime),
    provider: payload.syncProvider || nextState.settings.cloudSync.provider || "vercel-proxy",
    apiBaseUrl: String(payload.syncApiBaseUrl || nextState.settings.cloudSync.apiBaseUrl || "/api/sync").trim(),
    ...
    workspaceId: String(payload.syncWorkspaceId || nextState.settings.cloudSync.workspaceId || payload.syncWorkspaceKey || nextState.settings.cloudSync.workspaceKey || "").trim(),
